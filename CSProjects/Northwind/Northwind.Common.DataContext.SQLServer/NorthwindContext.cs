...
public partial class NorthwindContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        {
            optionsBuilder.UseSqlServer(@"Data Source=WS124\SQLEXPRESS;Initial Catalog=Northwind;Integrated Security=true;MultipleActiveResultSets=true;TrustServerCertificate=true");
        }
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Region>(entity =>
        {
            ...
            entity.Property(e => e.RegionId).ValueGeneratedNever(); // Removed, as it forces key properties to never generate a value automatically
